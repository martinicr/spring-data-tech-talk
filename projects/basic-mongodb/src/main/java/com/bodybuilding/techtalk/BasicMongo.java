 ...
 * 
 */
package com.bodybuilding.techtalk;
...
public class BasicMongo {
	...
	private static DBObject fromCustomerToDBObject(Customer customer) {
		...
		customerDoc.put("emailAddress", emailAddressDoc);
	...
	private static Customer fromDBObjectToCustomer(DBObject obj) {
		...
		DBObject emailDoc = (BasicDBObject)obj.get("emailAddress");
		EmailAddress email = new EmailAddress(emailDoc.get("email").toString());
